...
(cl:defmethod cl:initialize-instance :after ((m <BoolStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BoolStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name srl_laser_segmentation-msg:<BoolStamped> is deprecated: use srl_laser_segmentation-msg:BoolStamped instead.")))
...
(cl:defmethod data-val ((m <BoolStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader srl_laser_segmentation-msg:data-val is deprecated.  Use srl_laser_segmentation-msg:data instead.")
  (data m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<BoolStamped>)))
  ...
  "srl_laser_segmentation/BoolStamped")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BoolStamped)))
  "Returns string type for a message object of type 'BoolStamped"
  "srl_laser_segmentation/BoolStamped")
