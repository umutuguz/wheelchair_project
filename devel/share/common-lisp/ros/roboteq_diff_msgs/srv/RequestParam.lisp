...
(cl:defmethod cl:initialize-instance :after ((m <RequestParam-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RequestParam-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboteq_diff_msgs-srv:<RequestParam-request> is deprecated: use roboteq_diff_msgs-srv:RequestParam-request instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <RequestParam-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboteq_diff_msgs-srv:name-val is deprecated.  Use roboteq_diff_msgs-srv:name instead.")
  (name m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RequestParam-request>)))
  ...
  "roboteq_diff_msgs/RequestParamRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RequestParam-request)))
  "Returns string type for a service object of type 'RequestParam-request"
  "roboteq_diff_msgs/RequestParamRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <RequestParam-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RequestParam-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboteq_diff_msgs-srv:<RequestParam-response> is deprecated: use roboteq_diff_msgs-srv:RequestParam-response instead.")))

(cl:ensure-generic-function 'ints-val :lambda-list '(m))
(cl:defmethod ints-val ((m <RequestParam-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboteq_diff_msgs-srv:ints-val is deprecated.  Use roboteq_diff_msgs-srv:ints instead.")
  (ints m))

(cl:ensure-generic-function 'floats-val :lambda-list '(m))
(cl:defmethod floats-val ((m <RequestParam-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboteq_diff_msgs-srv:floats-val is deprecated.  Use roboteq_diff_msgs-srv:floats instead.")
  (floats m))

(cl:ensure-generic-function 'strings-val :lambda-list '(m))
(cl:defmethod strings-val ((m <RequestParam-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboteq_diff_msgs-srv:strings-val is deprecated.  Use roboteq_diff_msgs-srv:strings instead.")
  (strings m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RequestParam-response>)))
  ...
  "roboteq_diff_msgs/RequestParamResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RequestParam-response)))
  "Returns string type for a service object of type 'RequestParam-response"
  "roboteq_diff_msgs/RequestParamResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RequestParam)))
  ...
  "roboteq_diff_msgs/RequestParam")