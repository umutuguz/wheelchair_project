...
(cl:defmethod cl:initialize-instance :after ((m <Quaternion>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Quaternion)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboteq_diff_msgs-msg:<Quaternion> is deprecated: use roboteq_diff_msgs-msg:Quaternion instead.")))
...
(cl:defmethod w-val ((m <Quaternion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboteq_diff_msgs-msg:w-val is deprecated.  Use roboteq_diff_msgs-msg:w instead.")
  (w m))
